...
export default function Process() {
  const [activeAccordion, setActiveAccordion] = useState<number | null>(serviceProcessItems[0].id);


  // Open accordion on hover and close on mouse leave
        ...
        >
          <div className="w-full flex items-center justify-between py-[10px] padding-x">
            ...
            <div className="w-[10%] sm:w-full xm:w-full flex items-end justify-end">
              {/* Remove the click button as hover controls now */}
              <span
